...
def custom():
    try:
        ...
        print('''In order to build your very own custom notification you need to enter a suitable Title, Message and a Timeout.''')
        print("")
        ...
        print("If you want an no app icon then enter '1'")
        print("")
